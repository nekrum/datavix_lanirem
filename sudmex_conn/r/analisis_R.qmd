...
:::{.callout-note}
Al usar `here()` expande la ruta del repositorio para guardar los archivos.
:::
...
A partir de las rutas de archivos en el sitio web podemos generar los links de descarga
y las rutas para guardar los archivos, todo recolectado en un dataframe.
